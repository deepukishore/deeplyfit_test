...
const s = createThemedStyles(() => ({
  ...
  microPercent: { color: colors.accentPurple, backgroundColor: colors.glowPurple, borderRadius: 10, overflow: 'hidden', paddingHorizontal: 6, paddingVertical: 2, fontSize: 9, fontWeight: '800' },
  ...
  plannerHero: { backgroundColor: colors.glowPurple, borderRadius: radius.lg, padding: 14, borderWidth: 1, borderColor: colors.border, marginBottom: 12 },
  ...
  plannerHint: { backgroundColor: colors.glowPurple, borderRadius: radius.lg, padding: 14, borderWidth: 1, borderColor: colors.border, marginBottom: 16 },
  ...
  entryModeBtnActive: { backgroundColor: colors.bgCard, borderWidth: 1, borderColor: colors.border },
  ...
  choiceChipActive: { backgroundColor: colors.glowPurple, borderColor: colors.accentPurple },
