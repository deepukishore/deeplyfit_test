...
const s = createThemedStyles(() => ({
  ...
  quoteCard: { backgroundColor: colors.bgCard, borderRadius: radius.xl, padding: spacing.lg, marginBottom: spacing.md, borderWidth: 1, borderColor: colors.border, shadowColor: '#000000', shadowOpacity: 0.12, shadowRadius: 15, shadowOffset: { width: 0, height: 7 }, elevation: 3 },
  quoteText: { color: colors.textSecondary, fontSize: 13, fontStyle: 'italic', lineHeight: 20 },
  card: { backgroundColor: colors.bgCard, borderRadius: radius.xl, padding: spacing.lg, marginBottom: spacing.md, borderWidth: 1, borderColor: colors.border, shadowColor: '#000000', shadowOpacity: 0.13, shadowRadius: 14, shadowOffset: { width: 0, height: 6 }, elevation: 3 },
  ...
  missionScoreComplete: { backgroundColor: colors.glowPurple, borderColor: colors.accentLime },
  ...
  missionRowComplete: { backgroundColor: colors.glowPurple, borderColor: colors.border },
  ...
  quickBtn: { flexBasis: '47%', flexGrow: 1, minHeight: 66, flexDirection: 'row', alignItems: 'center', backgroundColor: colors.bgElevated, borderRadius: radius.lg, paddingHorizontal: 11, paddingVertical: 10, borderWidth: 1, borderColor: colors.border, shadowColor: '#000000', shadowOpacity: 0.1, shadowRadius: 5, shadowOffset: { width: 0, height: 2 }, elevation: 1 },
  ...
  suggestionCalories: { color: colors.accentLime, fontSize: 10, fontWeight: '800', backgroundColor: colors.glowPurple, borderRadius: 12, overflow: 'hidden', paddingHorizontal: 8, paddingVertical: 4 },
  ...
  sheet: { backgroundColor: colors.bgCard, borderTopLeftRadius: 28, borderTopRightRadius: 28, padding: spacing.xl, maxHeight: '90%', borderWidth: 1, borderColor: colors.border, shadowColor: '#000000', shadowOpacity: 0.3, shadowRadius: 24, shadowOffset: { width: 0, height: -9 }, elevation: 22 },
